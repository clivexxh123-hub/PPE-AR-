    ...
    checks = [
        Check(
            ...
            [
                ...
                "scripts/vest_print_placement_smoke_test.py",
                ...
                "scripts/human_wearing_anchor_smoke_test.py",
                "scripts/ppe_blend_smoke_test.py",
        ...
        Check("安全帽四面印刷定位", [PYTHON, "scripts/helmet_print_centering_smoke_test.py"], engine="mock"),
        Check("马甲五区域印刷定位", [PYTHON, "scripts/vest_print_placement_smoke_test.py"], engine="mock"),
        ...
        Check("human_wearing 人体锚点定位", [PYTHON, "scripts/human_wearing_anchor_smoke_test.py"], engine="mock"),
        Check("PPE 局部融合 mask 与工作流", [PYTHON, "scripts/ppe_blend_smoke_test.py"], engine="mock"),
