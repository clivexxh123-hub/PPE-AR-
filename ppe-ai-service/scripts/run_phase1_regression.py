    ...
    checks = [
        Check(
            ...
            [
                ...
                "scripts/multi_product_scene_smoke_test.py",
                "scripts/human_wearing_model_anchor_audit.py",
                "scripts/helmet_contact_refinement_smoke_test.py",
                "scripts/human_wearing_modularization_smoke_test.py",
        ...
        Check("三产品穿戴、所选场景与印刷标准", [PYTHON, "scripts/multi_product_scene_smoke_test.py"], engine="mock"),
        Check("标准模特人体锚点审计", [PYTHON, "scripts/human_wearing_model_anchor_audit.py"], engine="mock"),
        Check("helmet 接触带、核心锁定与固定 seed", [PYTHON, "scripts/helmet_contact_refinement_smoke_test.py"], engine="mock"),
        Check("human_wearing 模块边界行为保持", [PYTHON, "scripts/human_wearing_modularization_smoke_test.py"], engine="mock"),
