...
def main() -> None:
    temporary_output = tempfile.TemporaryDirectory(prefix="ppe-logo-remove-smoke-")
    ...
    try:
        ...
        magenta_logo_path = inputs / "magenta_logo.png"
        ...
        print(f"LOGO_REMOVE_BG_SMOKE_OK output={image_path}")
    finally:
