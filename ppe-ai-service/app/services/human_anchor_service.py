...
def resolve_ppe_placements(
    ...
    """Compatibility entry point for category-specific placement strategies."""
    from app.services.human_wearing_categories import resolve_ppe_placements as _resolve

    return _resolve(anchors, ppe_category, ppe_aspect)
